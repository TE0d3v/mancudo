  ...
  return (
    <div className="flex flex-col flex-1 w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-24">
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        ...
        >
          <h2 className="font-rocker text-5xl sm:text-6xl md:text-8xl mb-2 tracking-wide uppercase text-white drop-shadow-md">
            QUEM TÁ RISCANDO?
          </h2>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mt-24">
        ...
        >
          <h1 className="font-rocker text-4xl sm:text-5xl md:text-7xl mb-8 tracking-wide uppercase text-white drop-shadow-md">
            Mancudo
          </h1>
        ...
        >
          ...
          <Image
            ...
            fill
            sizes="(max-width: 1024px) 100vw, 50vw"
            className={`object-cover transition-all duration-300 scale-105 hover:scale-100 ${isGlitched ? "grayscale-0 scale-100 opacity-90" : "grayscale hover:grayscale-0"
              }`}
          />
